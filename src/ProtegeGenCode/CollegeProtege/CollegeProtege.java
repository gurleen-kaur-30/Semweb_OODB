package ProtegeGenCode.CollegeProtege;
 ...
 */
public class CollegeProtege implements CodeGenerationFactory {
    private OWLOntology ontology;
    private ProtegeJavaMapping javaMapping = new ProtegeJavaMapping();
    private FactoryHelper delegate;
    private CodeGenerationInference inference;

    public CollegeProtege(OWLOntology ontology) {
	    this(ontology, new SimpleInference(ontology));
    }
    
    public CollegeProtege(OWLOntology ontology, CodeGenerationInference inference) {
...
//    	System.out.println(inference.getIndividuals(Vocabulary.CLASS_COLLEGE));
