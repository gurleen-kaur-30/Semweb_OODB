 ...
 * Source Class: DefaultAdults <br>
 * @version generated on Sun May 16 23:25:38 IST 2021 by gurleen
 */
@Entity
 public class DefaultAdults extends WrappedIndividualImpl implements Adults , Serializable {
...
@Embedded private Collection<? extends People> HasMother;
    ...
    public DefaultAdults(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
		 name = iri.toString();
